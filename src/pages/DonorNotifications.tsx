...
//  * Displays active blood requests and allows donors to respond
//  */
...
// import { Bell, Clock, MapPin, AlertTriangle, CheckCircle, XCircle } from "lucide-react";
...
//     console.log("Logged user:", userProfile);
...
//               You'll be notified here when hospitals near you need your blood type.
//             </p>
...
//                         className="flex-1 bg-green-500 text-white py-2.5 rounded-lg hover:bg-green-600 transition disabled:opacity-50 font-medium"
//                       >
...
//                         }
//                         disabled={responding === notification.id}
//                         className="flex-1 bg-gray-200 text-gray-700 py-2.5 rounded-lg hover:bg-gray-300 transition disabled:opacity-50 font-medium"
//                       >
//                         Decline
//                       </button>
...
//     loadNotifications();
//     const interval = setInterval(loadNotifications, 30000);
//    console.log("Auth ID:", userProfile.auth_user_id)
...
//     const data: Notification[] = await getUserNotifications(auth.user.id, "donor")
...
//                     <p>
//                       <strong>Blood Type:</strong> {request.blood_group}
//                     </p>

//                     <p>
//                       <strong>Units:</strong> {request.quantity}
//                     </p>

//                     <p>
//                       <strong>Hospital:</strong> {hospital?.address}
//                     </p>
...
{notification.status === "expired" && (
  ...
  <div className="bg-gray-50 rounded-lg p-3 flex items-center space-x-2 mt-3">
    ...
    <span className="text-sm text-gray-600">
      This request was fulfilled by another donor
    </span>
